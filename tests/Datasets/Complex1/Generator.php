...
readonly class Generator
{
    public function generate(): RouteData
    {
        ...
        return new RouteData(
            ...
            locations: $this->generateLocationDetails($faker, $faker->numberBetween(3, 5)),
            clients: $this->generateClientDetails($faker, $faker->numberBetween(3, 5)),
            assets: $this->generateAssetDetails($faker, $faker->numberBetween(1, 3)),
            shipments: $this->generateShipmentDetails($faker, $faker->numberBetween(3, 5)),
